<template><h1 id="_1-jsx简介" tabindex="-1"><a class="header-anchor" href="#_1-jsx简介" aria-hidden="true">#</a> 1 JSX简介</h1>
...
<h1 id="_2-jsx本质" tabindex="-1"><a class="header-anchor" href="#_2-jsx本质" aria-hidden="true">#</a> 2 JSX本质</h1>
<p>在React官网中有这样的解释：</p>
...
<h1 id="_3-jsx语法" tabindex="-1"><a class="header-anchor" href="#_3-jsx语法" aria-hidden="true">#</a> 3 JSX语法</h1>
<p>jsx中<code>()</code>可以用来换行，即括号内的内容是可以在新的一行书写。</p>
<p>jsx语句中有三个核心的概念：标签名、props、子元素。对JSX语法的介绍也主要分为这三部分进行：</p>
<h2 id="_3-1-标签名" tabindex="-1"><a class="header-anchor" href="#_3-1-标签名" aria-hidden="true">#</a> 3.1 标签名</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="_3-2-props" tabindex="-1"><a class="header-anchor" href="#_3-2-props" aria-hidden="true">#</a> 3.2 props</h2>
...
<p>以下两个组件是等价的：</p>
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>function App1() {
...
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>const Button = props =&gt; {
...
<h2 id="_3-3-子元素" tabindex="-1"><a class="header-anchor" href="#_3-3-子元素" aria-hidden="true">#</a> 3.3 子元素</h2>
<p>包含在开始和结束标签之间的 JSX 表达式内容将作为特定属性 <code>props.children</code> 传递给外层组件。有几种不同的方法来传递子元素：</p>
<h3 id="字符串字面量" tabindex="-1"><a class="header-anchor" href="#字符串字面量" aria-hidden="true">#</a> 字符串字面量</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
  ...
  World
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="jsx-子元素" tabindex="-1"><a class="header-anchor" href="#jsx-子元素" aria-hidden="true">#</a> JSX 子元素</h3>
<p>子元素允许由多个 JSX 元素组成。你可以将不同类型的子元素混合在一起，因此你可以将字符串字面量与 JSX 子元素一起使用。这对于嵌套组件非常有用：</p>
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>&lt;MyContainer&gt;
   Here is a list:
  &lt;MyFirstComponent /&gt;
  &lt;MySecondComponent /&gt;
&lt;/MyContainer&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h3 id="javascript-表达式作为子元素" tabindex="-1"><a class="header-anchor" href="#javascript-表达式作为子元素" aria-hidden="true">#</a> JavaScript 表达式作为子元素</h3>
<p>JavaScript 表达式可以被包裹在 <code>{}</code> 中作为子元素。这对于展示任意长度的列表非常有用。例如，渲染 HTML 列表：</p>
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>function Item(props) {
...
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>function Hello(props) {
  return &lt;div&gt;Hello {props.addressee}!&lt;/div&gt;;
}
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="函数作为子元素" tabindex="-1"><a class="header-anchor" href="#函数作为子元素" aria-hidden="true">#</a> 函数作为子元素</h3>
...
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>// 调用子元素回调 numTimes 次，来重复生成组件
...
<h3 id="布尔类型、null-以及-undefined-将会忽略" tabindex="-1"><a class="header-anchor" href="#布尔类型、null-以及-undefined-将会忽略" aria-hidden="true">#</a> 布尔类型、Null 以及 Undefined 将会忽略</h3>
...
<div class="language-react ext-react line-numbers-mode"><pre v-pre class="language-react"><code>&lt;div&gt;
